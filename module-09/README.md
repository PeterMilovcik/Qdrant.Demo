...
1. Clear the Text field and paste a long text (e.g., the coffee history article from Module 7 — over 3000 characters)
...
| 9 | Chat UI — static frontend for every endpoint |
...
2. **Stop Docker containers** — from the `module-09` directory:
